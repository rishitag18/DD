...
def startMonitoring():
    ...
    svm_predictor_path = '/Users/harsh/Downloads/Drowsiness-Detection/Drowsiness-Detection/SVMclassifier.dat'
    EYE_AR_THRESH = 0.25
    ...
    while True:
        ...
        for rect in rects:
            ...
            cv2.putText(frame,"Visual Behaviour & Drowsiness Detection",(30,470),cv2.FONT_HERSHEY_COMPLEX,0.7,(249,249,249),1)
